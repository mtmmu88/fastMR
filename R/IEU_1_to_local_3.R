#' @title 多变量暴露工具变量合并
#' @description 适用于1个来自IEU的暴露，3个来自非IEU的暴露工具变量合并
#' @param data1IV 来自IEU暴露1工具变量文件
#' @param GWASID 来自IEU暴露1的GWAS ID号
#' @param data2IV 来自非IEU暴露工具变量文件
...
#' @export
IEU_1_to_local_3<-function(data1IV,GWASID,data2IV,data2GWAS,data3IV,data3GWAS,data4IV,data4GWAS){
   library(tidyr)
  ...
  #合并工具变量
  exposure_dat_temp<-rbind(MVIV1_1,MVIV1_2,MVIV1_3,MVIV1_4,MVIV2_2,MVIV2_1,MVIV2_3,MVIV2_4,MVIV3_3,MVIV3_1,MVIV3_2,MVIV3_4,MVIV4_4,MVIV4_1,MVIV4_2,MVIV4_3)
  #写出工具变量剔除唯一的SNP
  library(tidyr)
